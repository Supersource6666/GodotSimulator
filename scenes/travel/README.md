...
承轨台和扣件在 outdoors_track.gd 中按照片轮廓生成：台座采用低矮坡面、薄底沿和倒角，底面 0.64 × 0.38 m，混凝土高 0.063 m，顶部承载面 0.414 × 0.29 m，纵向间距 0.65 m，首排中心距线路起点 0.325 m。每块 6.5 m 轨道板布置 10 排，板缝位于相邻两排中间，台座边缘距 25 mm 板缝边缘为 0.1225 m；线路末端只放置完整台座。尺寸为外观近似，并非照片测量值。每套扣件含 14 mm 橡胶垫板、两侧挡肩、深灰绝缘块、垫圈、六角螺母、螺栓端部和双回弯弹条（中部由压紧垫圈与大螺母压住、两端压在轨底绝缘块上）。两侧金属底板各为 0.115 × 0.24 m，含边沿的横向总包络为 0.40 m，收在承轨台顶部倒角轮廓以内；不设外侧螺旋弹簧锚固螺栓。轨底位于板面以上 0.077 m；钢轨高 0.16 m，轨顶为 0.397 m，列车轮底同步对齐。轨头内侧间距 1.435 m，中心距 1.505 m。台座与扣件使用共享网格、分块 MultiMesh 和距离裁剪。
